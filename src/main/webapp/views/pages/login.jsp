...
<div class="section">
    <div class="row">
        ...
        <div class="col-md-4 col-md-offset-2">
            <img class="login-banner" src="./img/login-banner.png" alt="login-banner">
        </div>
            ...
            <div class="login-container">
                <div class="soft-card">
                    <div class="comfort-header">
                        ...
                        <p class="gentle-subtitle">Đăng nhập vào không gian mua sắm thỏa thích!</p>
                    </div>
                    ...
                    <div class="comfort-signup">
                        ...
                        <a href="#" class="comfort-link signup-link">Đăng kí</a>
                    </div>
