...
<body>
  ...
  <aside id="sidebar" class="sidebar">
    ...
    <ul class="nav flex-column">
      ...
      <li><a class="nav-link" href="create-product.jsp"><i class="ti ti-plus"></i><span class="nav-text">Add
            Product</span></a></li>
    <li><a class="nav-link" href="reports.html"><i class="ti ti-receipt"></i><span class="nav-text">Reports</span></a>
      </li>
    <li><a class="nav-link" href="error-page.jsp"><i class="ti ti-alert-circle"></i><span class="nav-text">404 Error</span></a>
      </li>
      ...
      <div class="row">
        <div class="col-12">
          <div class="d-flex justify-content-between align-items-center mb-4">
            ...
            <div>
              <a href="create-product.jsp" class="btn btn-primary">Add Product</a>
            </div>
          </div>
        </div>
      </div>
